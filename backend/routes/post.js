...
cloudinary.config({
    cloud_name: process.env.CLOUDINARY_CLOUD_NAME || "dfmmmkwmk",
    api_key: process.env.CLOUDINARY_API_KEY || "384322579685734",
    api_secret: process.env.CLOUDINARY_API_SECRET || "u8qHEqVeUG4r4Y6qG1fSejnd0PI",
  });
